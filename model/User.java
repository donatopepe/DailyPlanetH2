...
public class User implements Serializable {
    ...
    private void addDomanda(DomandaLavoro domanda)
    {
        domanda.setUser(this);
        domande.add(domanda);
    }
    private void removeDomanda(DomandaLavoro domanda)
    {
    ...
    private void addCommento(Commento commento)
    {
        commenti.add(commento);
    }
    private void removeDomanda(Commento commento)
    {
